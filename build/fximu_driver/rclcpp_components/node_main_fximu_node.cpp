...
#define NODE_MAIN_LOGGER_NAME "fximu_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libfximu_driver_nodes.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<drivers::fximu_driver::FximuNode>";
